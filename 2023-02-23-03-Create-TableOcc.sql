...
insert into TABLE_OCC (INSTITUTE_OR_COMPANY, EVENT_TITLE, INFORMATION_1, INFORMATION_2, INFORMATION_3, FOUNDATION_PAGE, NAME_PHONE, Phone_Number, DATE_INFORMACION, HOUR_INFORMACION, PROVINCIE, url_cita)
VALUES('Ajuntament Barcelona CAT','How to access a psychological consultation in public health?','See your GP at a Primary Care Center (CAP)','He/she will listen to you, and he/she will be able to guide you based on your situation','If necessary, he will guide you to the Adult Mental Health Center in your district','https://ajuntament.barcelona.cat/joves/es/canal/et-poden-ajudar-i-informar-12','CatSalut Respon :','061',NULL,'','Barcelona', 'www.cita.com');
insert into TABLE_OCC (INSTITUTE_OR_COMPANY, EVENT_TITLE, INFORMATION_1, INFORMATION_2, INFORMATION_3, FOUNDATION_PAGE, NAME_PHONE, Phone_Number, DATE_INFORMACION, HOUR_INFORMACION, PROVINCIE, url_cita)
VALUES('Ajuntament Barcelona CAT','Emergencies','In an emergency, go to a hospital or Adult Mental Health Center (walk-in)','','','https://ajuntament.barcelona.cat/sanitatisalut/ca/canal/estrategia-de-prevencio-del-suicidi','Suicide Prevention Phone:','900 92 55 55',NULL,'','Barcelona', NULL);
insert into TABLE_OCC (INSTITUTE_OR_COMPANY, EVENT_TITLE, INFORMATION_1, INFORMATION_2, INFORMATION_3, FOUNDATION_PAGE, NAME_PHONE, Phone_Number, DATE_INFORMACION, HOUR_INFORMACION, PROVINCIE, url_cita)
VALUES('Ajuntament Barcelona CAT','Other public resources','Cabàs Emotional: videos and articles, mental health resources + list of activities. Problem: all the contents are in Catalan.','','','https://ajuntament.barcelona.cat/joves/es/canal/et-poden-ajudar-i-informar-12','Telephone psychological support for domestic workers and self-employed workers: ','900 505 805',NULL,'','Barcelona','www.cita.com');
insert into TABLE_OCC (INSTITUTE_OR_COMPANY, EVENT_TITLE, INFORMATION_1, INFORMATION_2, INFORMATION_3, FOUNDATION_PAGE, NAME_PHONE, Phone_Number, DATE_INFORMACION, HOUR_INFORMACION, PROVINCIE, url_cita)
VALUES('UMBRAL Red De Asistecia PSI','Foundations/NGOs programs','Psychological care network (not free, fees agreed with the client)','','','https://www.umbral-red.org/es/atencion-clinica/dispositivo.html','CLINICAL CARE/ REFERRALS','652 071 594/685 500 556/615 601 421',NULL,'','Barcelona', NULL);
insert into TABLE_OCC (INSTITUTE_OR_COMPANY, EVENT_TITLE, INFORMATION_1, INFORMATION_2, INFORMATION_3, FOUNDATION_PAGE, NAME_PHONE, Phone_Number, DATE_INFORMACION, HOUR_INFORMACION, PROVINCIE, url_cita)
VALUES('Parc Sanitari Sant Joan de Déu','Specialized programs for migrants and refugees:','Sant Joan de Déu Health Park has a list of programs within the health and social field in order to offer the best care to the people it serves.','','','https://www.pssjd.org/serveis-assitencials/xarxa-salut-mental/programes','Sant Joan de Deu Health Park - Headquarters, telephone','936 61 52 08',NULL,'','Barcelona', 'www.cita.com');
insert into TABLE_OCC (INSTITUTE_OR_COMPANY, EVENT_TITLE, INFORMATION_1, INFORMATION_2, INFORMATION_3, FOUNDATION_PAGE, NAME_PHONE, Phone_Number, DATE_INFORMACION, HOUR_INFORMACION, PROVINCIE, url_cita)
VALUES('BABEL','Bridges Project Reception and psychological support for migrants and/or refugees in Barcelona','Puentes is a consolidated project with a history of fourteen years, which to this day continues to demonstrate its social impact. The project is intended to offer reception and accompaniment to people who have recently arrived in our society or who at some stage of their lives have experienced a migratory process','To this end, free accompaniment sessions are offered with a psychologist, focused on the psychosocial dimension of migration.','','https://www.babelpuntodeencuentro.org/proyecto/proyecto-puentes-4/#acceso','Babel Foundation Meeting point, telephone','629 57 74 30',NULL,'','Barcelona', NULL);
insert into TABLE_OCC (INSTITUTE_OR_COMPANY, EVENT_TITLE, INFORMATION_1, INFORMATION_2, INFORMATION_3, FOUNDATION_PAGE, NAME_PHONE, Phone_Number, DATE_INFORMACION, HOUR_INFORMACION, PROVINCIE, url_cita)
